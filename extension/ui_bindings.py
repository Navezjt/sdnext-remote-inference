...
def bind_component(component):
    ...
    if uibindings.ready_for_binding():
        ...
        #todo generation cost estimation
...
def update_balances():
    ...
    values = ['' if not show else value for show in [modules.shared.opts.show_remote_balance_box, modules.shared.opts.show_remote_balance_quick]]
